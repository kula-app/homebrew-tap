# Homebrew formula template for `ship` (stable channel).
# Moved here from kula-app/ship per the publisher design migration. Rendered by
# .github/workflows/_homebrew.yml and PR'd to kula-app/homebrew-tap.
#
# url points at the registry (packages.kula.app), NOT at GitHub Release assets,
...
class Ship < Formula
  ...
  on_macos do
    on_arm do
      url "https://packages.kula.app/ship/bin/v0.0.5/ship-darwin-arm64"
      sha256 "9535062465c330dda2d0087cf1e0118bc80345704759b30ef3e408af304010ce"
    end
    on_intel do
      url "https://packages.kula.app/ship/bin/v0.0.5/ship-darwin-amd64"
  ...
  on_linux do
    on_arm do
      url "https://packages.kula.app/ship/bin/v0.0.5/ship-linux-arm64"
      sha256 "1ea9d9bc41d5c1cc93e1fb8acc57685d1c03978e832ff5fdce38d365666c6019"
    end
    on_intel do
      url "https://packages.kula.app/ship/bin/v0.0.5/ship-linux-amd64"
